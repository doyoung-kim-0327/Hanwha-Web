  ...
  <%@include file="navbar.jsp" %>
	...
	<div class="container-fluid p-0">
		...
		<section class="resume-section p-3 p-lg-5 d-flex justify-content-center" id="experience">
			...
			<form action="editpost2" method="post">
				<div class="mb-3">
					<input type="hidden" name="pid" value="${post.pid }">
					<input type="hidden" name="pdate" value="${post.pdate }">
					<label for="title">제목</label>
					<input type="text" class="form-control" name="ptitle" value="${post.ptitle }">
				</div>
				<div class="mb-3">
					<label for="content">내용</label>
					<textarea class="form-control" rows="10" name="pcontent" id="pcontent">${post.pcontent }</textarea>
					<input type="hidden" name="poster" value="${post.poster }">
				</div>
				<div class="edit-btn">
					<input type="submit" value="수정"  class="btn btn-info">
					<a href="qnaboard" class="btn btn-info" role="button">취소</a>
				</div>
